...
namespace Movie.ApiIntegration.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        [HttpPost("admin")]
        public async Task<IActionResult> SignInAdmin([FromBody]AccountRequest account)
        {
            return Ok(ResponseBase.Success(await _unitOfWork.Account.SignInAdminAsync(account)));
        }
        [HttpPost]
        [Route("register")]
