...
namespace Movie.ApiIntegration.Controllers
{
    ...
    public class MovieController : ControllerBase
    {
        ...
        {
            var movieAdded = await _unitOfWork.Movie.AddOrUpdateMovieAsync(movieDtos, false);
            var movie = _mapper.Map<MovieResponse>(movieAdded);
        ...
        {
            var movieUpdated = await _unitOfWork.Movie.AddOrUpdateMovieAsync(movieDtos, true, id);
