...
export const theme = (customization) => {
    ...
    if(customization.layout === "dark"){
        ...
        themeOption = {
            ...
            filter: color.secondaryLight,
            menu: color.secondaryLight,
            menuColor: color.secondaryDark,
            customization
        };
    }
